...
if(isset($_POST['update_topsection'])) {
  ...
  mysqli_next_result($connection);
  $update_topsection_query = mysqli_query($connection,"CALL updatebanner1('$main_text','$main_tagline')");
  mysqli_next_result($connection);
...
?>
     ...
     <div class="form-group">
        <label for="main_text">Main Title</label>
         <input type="text" value="<?php echo $main_text; ?>" class="form-control" name="main_text">
     </div>

      <div class="form-group">
        <label for="main_tagline">Main Tagline</label>
         <input type="text" value="<?php echo $main_tagline; ?>" class="form-control" name="main_tagline">
     </div>    
