...
<?php
     if(isset($_GET['ID_Menu'])){
      ...
      $select_all_menu_query = mysqli_query($connection,"CALL selectFooterMenu('$the_menu_id')");
      mysqli_next_result($connection);
...
if(isset($_POST['update_menu'])) {
  ...
  mysqli_next_result($connection);
  $update_menu_query = mysqli_query($connection,"CALL updateFooterReferencat('$Emri_Menu','$Link','$the_menu_id')");
  mysqli_next_result($connection);
  if(!$update_menu_query){
    echo mysqli_error($connection);
  } else {
      echo "Referenca u perditsua me sukses: " . " " . "<a href='admin.php'> Shiko të gjith Referencat</a> ";
  }
