...
<?php
     if(isset($_GET['ID_Menu'])){
      ...
      $select_all_menu_query = mysqli_query($connection,"CALL selectMenuUserUpdate('$the_menu_id')");
      mysqli_next_result($connection);
...
if(isset($_POST['update_menu'])) {
  ...
  mysqli_next_result($connection);
  $update_menu_query = mysqli_query($connection,"CALL updateMenuUser('$Emri_Menu','$Link','$the_menu_id')");
  mysqli_next_result($connection);
